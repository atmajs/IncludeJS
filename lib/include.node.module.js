...
(function (WorkerRpcProxyUtils) {
    ...
    function createMethod(worker, filename, accessorPath) {
        return function () {
            ...
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, worker.call.apply(worker, __spreadArrays([filename, accessorPath], args))];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
    ...
    function createObject(worker, filename, accessorPath, exports) {
        ...
        for (var key in exports) {
            var exp = exports[key];
            var path = accessorPath ? accessorPath + "." + key : key;
...
var WorkerClientNode = /** @class */ (function () {
    function WorkerClientNode(workerFilename) {
        ...
        var path = workerFilename !== null && workerFilename !== void 0 ? workerFilename : (isDev ? cwd + "/lib/" + host : cwd + "/node_modules/includejs/lib/" + host);
...
;
	...
	if (isObject(_src_worker_WorkerClient) && isObject(module.exports)) {
...
;
	...
	if (isObject(_src_worker_WorkerLoader) && isObject(module.exports)) {
...
function createLoader(url, options) {
    ...
    var extension = path_1.path_getExtension(url);
...
global_1.refs.XMLHttpRequest = /** @class */ (function () {
    ...
    XMLHttpRequest.prototype.on = function (event, cb) {
        if (event === 'error') {
            this.onerror = cb;
            return;
        }
...
function internalEval(source, include, isGlobalCtx) {
    ...
    var f = path_1.path_toLocalFile((_a = include.id) !== null && _a !== void 0 ? _a : include.url);
    global_1.global.__filename = f;
    global_1.global.__dirname = path_1.path_getDir(f);
