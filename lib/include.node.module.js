...
exports.PathResolver = {
    ...
    resolveBasicWithData: function (path_, type, parent) {
        ...
        var data = {
            path: path,
            module: (_b = (_a = mapped1 === null || mapped1 === void 0 ? void 0 : mapped1.module) !== null && _a !== void 0 ? _a : mapped2 === null || mapped2 === void 0 ? void 0 : mapped2.module) !== null && _b !== void 0 ? _b : (path.include('/esm/') ? 'import' : null)
        };
        return data;
    },
